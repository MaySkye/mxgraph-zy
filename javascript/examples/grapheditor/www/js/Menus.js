...
//王伟注释：窗口菜单栏
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'run', 'help'];
...
Menus.prototype.init = function()
{
	...
	{
		this.addMenuItems(menu, ['new', 'open', '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print', 'Test_WW'], parent);
	})));
...
Menus.prototype.createPopupMenu = function(menu, cell, evt)
{
	...
	if (!graph.isSelectionEmpty())
	{
		if (graph.getSelectionCount() == 1)
		{
            ...
            this.addMenuItems(menu, ['sendCommand'], null, evt);
			this.addMenuItems(menu, ['EditDetectedValue'], null, evt);
		}
