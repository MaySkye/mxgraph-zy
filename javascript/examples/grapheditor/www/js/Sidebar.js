...
Sidebar.prototype.init = function()
{
    ...
    this.addDevicePalette('device', mxResources.get('device'), dir + '/device/', '.png',
        ['device1', 'device_11', 'device_21', 'device_31', 'device_41', 'device_51',
            'device_61', 'device_71', 'device_81', 'device_91', 'device_101',
            'device_receive', 'device_send'], "Device",
        {'EDFA中继器': 'wireless router switch wap wifi access point wlan',
            'Router_Icon': 'router switch'});
};
...
Sidebar.prototype.addDevicePalette = function(id, title, prefix, postfix, items, titles, tags)
{
    var showTitles = titles != null;
    var fns = [];
